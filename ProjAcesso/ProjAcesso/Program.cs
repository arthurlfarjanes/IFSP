...
namespace ProjetoAcesso
{
    class Program
    {
        ...
        {
            // ====================== TESTE ======================
            //Ambiente amb1 = new Ambiente(1, "Recepção");
            //Ambiente amb2 = new Ambiente(2, "Sala de Reuniões");
            //Ambiente amb3 = new Ambiente(3, "CPD");
            //Cadastro.AdicionarAmbiente(amb1);
            //Cadastro.AdicionarAmbiente(amb2);
            //Cadastro.AdicionarAmbiente(amb3);

            //Usuario user1 = new Usuario(101, "Ana Costa");
            //Usuario user2 = new Usuario(102, "Bruno Silva");
            //Cadastro.AdicionarUsuario(user1);
            //Cadastro.AdicionarUsuario(user2);

            //user1.ConcederPermissao(amb1); 
            //user1.ConcederPermissao(amb2); 
            //user2.ConcederPermissao(amb1); 
        ...
        private static void ConsultarAmbiente()
        {
            ...
            if (amb != null)
            {
                ...
                Console.WriteLine($"Nº de Logs Registrados: {amb.Logs.Count}");
            }
            else
            {
                Console.ForegroundColor = ConsoleColor.Red;
