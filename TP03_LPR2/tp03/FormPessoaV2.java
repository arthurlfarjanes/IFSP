...
public class FormPessoaV2 extends JFrame {
    ...
    public FormPessoaV2() {
        ...
        cmbSexo = new JComboBox<>(opcoesSexo);
        cmbSexo.setBounds(100, 100, 50, 25);
        add(cmbSexo);
        ...
        btnOk.addActionListener(e -> {
            try {
                ...
                // === V2 - ComboBox ===
                String sexoStr = (String) cmbSexo.getSelectedItem();
                if (txtNome.getText().isEmpty() || sexoStr.isEmpty() || txtIdade.getText().isEmpty()) {
